...
async function migrate() {
    ...
    try {
        ...
        // 3. Drop Old PK
        try {
            await db.execute(sql`ALTER TABLE "market_data" DROP CONSTRAINT IF EXISTS "market_data_symbol_id_timestamp_interval_pk"`);
        ...
        try {
             ...
             await db.execute(sql`ALTER TABLE "market_data" ADD CONSTRAINT "market_data_symbol_id_timestamp_interval_source_pk" PRIMARY KEY("symbol_id","timestamp","interval","source")`);
