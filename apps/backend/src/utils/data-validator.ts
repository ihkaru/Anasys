...
const DEFAULT_CONFIG: ValidationConfig = {
	...
	maxVolatilityCrypto: 0.6,
	maxPriceChangeStock: 0.2,
	maxPriceChangeCrypto: 0.5,
	maxWickRatio: 200.0, // Increased to 200.0 to handle extreme Dojis
	flashCrashThreshold: 0.2,
	minPrice: 0.0001,
};
...
export class DataValidator {
	...
	validateCandle(candle: CandleData, isCrypto: boolean = false): ValidationResult {
		...
		if (!candle.timestamp || Number.isNaN(candle.timestamp.getTime())) {
