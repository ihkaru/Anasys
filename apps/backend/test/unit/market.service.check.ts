...
import type { MarketService } from "../../src/modules/market/market.service";

// MOCK 1: yahoo-finance2
const mockHistorical = mock(() =>
	Promise.resolve([{ date: new Date(), open: 100, high: 105, low: 95, close: 102, volume: 1000 }]),
);
